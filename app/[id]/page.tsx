        ...
        <div>
            <div className="detail-content py-[10rem]">
                <div className="container mx-auto px-4">
                    <div className="block-content grid  md:grid-cols-2 gap-10">
                        ...
                        <div className="block-2 shadow-xl border-2 border-gray-200 p-20 h-[60rem] sticky top-0">
                            <div className='py-[2rem]'>
                                <h1 className='text-3xl'>Asking Pricing</h1>
                                <h1 className='text-2xl font-bold'>${product.price}</h1>
                            </div>
                            <hr />
                            <div className='grid grid-cols-1 gap-4 text-center py-[2rem]'>
                                <p className='px-10 py-3 bg-red-600 text-white rounded-lg'>BUSINESS SOLD OUT</p>
                                <p className='border-2 border-gray-300 px-10 py-3 rounded-lg'>VISIT STARTUP WEBSITE</p>
                            </div>
                            <hr />
